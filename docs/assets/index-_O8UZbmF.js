 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(S,A){var I=S.length;S.push(A);e:for(;0<I;){var H=I-1>>>1,J=S[H];if(0<i(J,A))S[H]=A,S[I]=J,I=H;else break e}}function r(S){return S.length===0?null:S[0]}function t(S){if(S.length===0)return null;var A=S[0],I=S.pop();if(I!==A){S[0]=I;e:for(var H=0,J=S.length,ke=J>>>1;H<ke;){var Ee=2*(H+1)-1,ue=S[Ee],le=Ee+1,fe=S[le];if(0>i(ue,I))le<J&&0>i(fe,ue)?(S[H]=fe,S[le]=I,H=le):(S[H]=ue,S[Ee]=I,H=Ee);else if(le<J&&0>i(fe,I))S[H]=fe,S[le]=I,H=le;else break e}}return A}function i(S,A){var I=S.sortIndex-A.sortIndex;return I!==0?I:S.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var u=[],c=[],v=1,y=null,p=3,m=!1,_=!1,j=!1,b=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h(S){for(var A=r(c);A!==null;){if(A.callback===null)t(c);else if(A.startTime<=S)t(c),A.sortIndex=A.expirationTime,n(u,A);else break;A=r(c)}}function w(S){if(j=!1,h(S),!_)if(r(u)!==null)_=!0,je(k);else{var A=r(c);A!==null&&O(w,A.startTime-S)}}function k(S,A){_=!1,j&&(j=!1,f(P),P=-1),m=!0;var I=p;try{for(h(A),y=r(u);y!==null&&(!(y.expirationTime>A)||S&&!Y());){var H=y.callback;if(typeof H=="function"){y.callback=null,p=y.priorityLevel;var J=H(y.expirationTime<=A);A=e.unstable_now(),typeof J=="function"?y.callback=J:y===r(u)&&t(u),h(A)}else t(u);y=r(u)}if(y!==null)var ke=!0;else{var Ee=r(c);Ee!==null&&O(w,Ee.startTime-A),ke=!1}return ke}finally{y=null,p=I,m=!1}}var E=!1,T=null,P=-1,N=5,L=-1;function Y(){return!(e.unstable_now()-L<N)}function Q(){if(T!==null){var S=e.unstable_now();L=S;var A=!0;try{A=T(!0,S)}finally{A?W():(E=!1,T=null)}}else E=!1}var W;if(typeof d=="function")W=function(){d(Q)};else if(typeof MessageChannel<"u"){var he=new MessageChannel,ye=he.port2;he.port1.onmessage=Q,W=function(){ye.postMessage(null)}}else W=function(){b(Q,0)};function je(S){T=S,E||(E=!0,W())}function O(S,A){P=b(function(){S(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(S){S.callback=null},e.unstable_continueExecution=function(){_||m||(_=!0,je(k))},e.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):N=0<S?Math.floor(1e3/S):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return r(u)},e.unstable_next=function(S){switch(p){case 1:case 2:case 3:var A=3;break;default:A=p}var I=p;p=A;try{return S()}finally{p=I}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(S,A){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var I=p;p=S;try{return A()}finally{p=I}},e.unstable_scheduleCallback=function(S,A,I){var H=e.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?H+I:H):I=H,S){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=I+J,S={id:v++,callback:A,priorityLevel:S,startTime:I,expirationTime:J,sortIndex:-1},I>H?(S.sortIndex=I,n(c,S),r(u)===null&&S===r(c)&&(j?(f(P),P=-1):j=!0,O(w,I-H))):(S.sortIndex=J,n(u,S),_||m||(_=!0,je(k))),S},e.unstable_shouldYield=Y,e.unstable_wrapCallback=function(S){var A=p;return function(){var I=p;p=A;try{return S.apply(this,arguments)}finally{p=I}}}})(Su);ju.exports=Su;var gf=ju.exports;/**
 * @license React
...
`;function mv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Hash Map"}),o.jsx("section",{id:"hashmap-find-number-of-subarrays",children:o.jsxs(g,{title:"find number of subarrays that fit an exact criteria",children:[o.jsx(g.Tab,{code:fv,language:"python"}),o.jsx(g.Tab,{code:pv,language:"javascript"})]})}),o.jsx("section",{id:"hashmap-sliding-window",children:o.jsxs(g,{title:"sliding window",children:[o.jsx(g.Tab,{code:hv,language:"python"}),o.jsx(g.Tab,{code:gv,language:"javascript"})]})})]})}const vv=`def fn(head):\r
    slow = head\r
    fast = head\r
    ans = 0\r
\r
...
`;function wv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Linked List"}),o.jsx("section",{id:"linkedlist-fast-and-slow-pointer",children:o.jsxs(g,{title:"fast and slow pointer",children:[o.jsx(g.Tab,{code:vv,language:"python"}),o.jsx(g.Tab,{code:xv,language:"javascript"})]})}),o.jsx("section",{id:"linkedlist-reverse",children:o.jsxs(g,{title:"reverse linked list",children:[o.jsx(g.Tab,{code:yv,language:"python"}),o.jsx(g.Tab,{code:_v,language:"javascript"})]})})]})}const jv=`def fn(arr):\r
    stack = []\r
    ans = 0\r
\r
    for num in arr:\r
...
`;function Tv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Stack"}),o.jsx("section",{id:"stack-monotonic-increasing",children:o.jsxs(g,{title:"monotonic increasing stack",children:[o.jsx(g.Tab,{code:jv,language:"python"}),o.jsx(g.Tab,{code:kv,language:"javascript"})]})}),o.jsx("section",{id:"stack-monotonic-decreasing",children:o.jsxs(g,{title:"monotonic decreasing stack",children:[o.jsx(g.Tab,{code:Sv,language:"python"}),o.jsx(g.Tab,{code:Ev,language:"javascript"})]})})]})}const Nv=`def dfs(root):\r
    if not root:\r
        return\r
\r
    ans = 0\r
...
\r
    return ans\r
`,bv=`from collections import deque\r
\r
\r
def fn(root):\r
    que = deque([root])\r
...
`;function Pv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Binary Tree"}),o.jsx("section",{id:"tree-dfs-recursive",children:o.jsxs(g,{title:"DFS (recursive)",children:[o.jsx(g.Tab,{code:Nv,language:"python"}),o.jsx(g.Tab,{code:Cv,language:"javascript"})]})}),o.jsx("section",{id:"tree-dfs-iterative",children:o.jsxs(g,{title:"DFS (iterative)",children:[o.jsx(g.Tab,{code:Ov,language:"python"}),o.jsx(g.Tab,{code:Av,language:"javascript"})]})}),o.jsx("section",{id:"tree-bfs",children:o.jsxs(g,{title:"BFS",children:[o.jsx(g.Tab,{code:bv,language:"python"}),o.jsx(g.Tab,{code:Rv,language:"javascript"})]})})]})}const Mv=`def fn(graph):\r
    def dfs(node):\r
        ans = 0\r
        # TODO: logic\r
...
\r
    return ans\r
`,Iv=`from collections import deque\r
\r
\r
def fn(graph):\r
...
\r
    return ans\r
`,Dv=`from heapq import heappop, heappush\r
\r
\r
...
\r
    return distances\r
`,Bv=`def bellman_ford(n: int, edges: list[tuple[int, int, int]], source: int) -> list[int]:\r
    distances = [float('inf')] * n\r
    distances[source] = 0\r
\r
...
\r
    return distances\r
`,zv=`from collections import defaultdict, deque\r
\r
\r
...
`,Fv=`def kruskal_mst(n: int, edges: list[tuple[int, int, int]]) -> list[tuple[int, int, int]]:\r
    mst = []\r
    uf = UnionFind(n)\r
    edges.sort()\r
\r
...
\r
    return mst\r
`,Uv=`from heapq import heappop\r
\r
\r
...
*/\r
`,Gv=`const bellmanFord = (n, edges, source) => {\r
...
`,Qv=`const kahnTopologicalSort = (graph) => {\r
    const result = []\r
    const queue = []\r
...
`,Kv=`/*\r
    ...
    Try using a language that doesn't hate you, like Python.\r
*/\r
`;function Jv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Graph"}),o.jsx("section",{id:"graph-dfs-recursive",children:o.jsxs(g,{title:"DFS (recursive)",children:[o.jsx(g.Tab,{code:Mv,language:"python"}),o.jsx(g.Tab,{code:Hv,language:"javascript"})]})}),o.jsx("section",{id:"graph-dfs-iterative",children:o.jsxs(g,{title:"DFS (iterative)",children:[o.jsx(g.Tab,{code:Lv,language:"python"}),o.jsx(g.Tab,{code:$v,language:"javascript"})]})}),o.jsx("section",{id:"graph-bfs",children:o.jsxs(g,{title:"BFS",children:[o.jsx(g.Tab,{code:Iv,language:"python"}),o.jsx(g.Tab,{code:Wv,language:"javascript"})]})}),o.jsx("section",{id:"graph-dijkstra",children:o.jsxs(g,{title:"Dijkstra (shortest path)",children:[o.jsx(g.Tab,{code:Dv,language:"python"}),o.jsx(g.Tab,{code:Yv,language:"javascript"})]})}),o.jsx("section",{id:"graph-bellman-ford",children:o.jsxs(g,{title:"Bellman-Ford (shortest path)",children:[o.jsx(g.Tab,{code:Bv,language:"python"}),o.jsx(g.Tab,{code:Gv,language:"javascript"})]})}),o.jsx("section",{id:"graph-kahn",children:o.jsxs(g,{title:"Kahn (topological sort)",children:[o.jsx(g.Tab,{code:zv,language:"python"}),o.jsx(g.Tab,{code:Qv,language:"javascript"})]})}),o.jsx("section",{id:"graph-kruskal",children:o.jsxs(g,{title:"Kruskal (mst)",children:[o.jsx(g.Tab,{code:Fv,language:"python"}),o.jsx(g.Tab,{code:Vv,language:"javascript"})]})}),o.jsx("section",{id:"graph-prim",children:o.jsxs(g,{title:"Prim (mst)",children:[o.jsx(g.Tab,{code:Uv,language:"python"}),o.jsx(g.Tab,{code:Kv,language:"javascript"})]})})]})}const Xv=`from heapq import heappop, heappush\r
\r
\r
def fn(arr, k):\r
    heap = []\r
...
`,Zv=`/*\r
    ...
    Try using a language that doesn't hate you, like Python.\r
*/\r
`;function qv(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Heap"}),o.jsx("section",{id:"heap-find-top-k-elements",children:o.jsxs(g,{title:"find top k elements",children:[o.jsx(g.Tab,{code:Xv,language:"python"}),o.jsx(g.Tab,{code:Zv,language:"javascript"})]})})]})}const ey=`def fn(arr, target):\r
    left = 0\r
    right = len(arr) - 1\r
\r
    while left <= right:\r
...
`;function cy(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Binary Search"}),o.jsx("section",{id:"binarysearch-binary-search",children:o.jsxs(g,{title:"binary search",children:[o.jsx(g.Tab,{code:ey,language:"python"}),o.jsx(g.Tab,{code:oy,language:"javascript"})]})}),o.jsx("section",{id:"binarysearch-duplicate-elements-left-insertion",children:o.jsxs(g,{title:"duplicate elements, left-most insertion point",children:[o.jsx(g.Tab,{code:ny,language:"python"}),o.jsx(g.Tab,{code:sy,language:"javascript"})]})}),o.jsx("section",{id:"binarysearch-duplicate-elements-right-insertion",children:o.jsxs(g,{title:"duplicate elements, right-most insertion point",children:[o.jsx(g.Tab,{code:ry,language:"python"}),o.jsx(g.Tab,{code:ly,language:"javascript"})]})}),o.jsx("section",{id:"binarysearch-greedy-minimum",children:o.jsxs(g,{title:"greedy (minimum)",children:[o.jsx(g.Tab,{code:ty,language:"python"}),o.jsx(g.Tab,{code:ay,language:"javascript"})]})}),o.jsx("section",{id:"binarysearch-greedy-maximum",children:o.jsxs(g,{title:"greedy (maximum)",children:[o.jsx(g.Tab,{code:iy,language:"python"}),o.jsx(g.Tab,{code:uy,language:"javascript"})]})})]})}const dy=`def backtrack(curr, OTHER_ARGUMENTS...):\r
    if (BASE_CASE):\r
...
\r
    return ans\r
`,fy=`const backtrack = (curr, OTHER_ARGUMENTS...) => {\r
    if (BASE_CASE) {\r
        // TODO: modify answer\r
        return\r
    }\r
...
\r
    return dp[STATE_FOR_WHOLE_INPUT]\r
`,my=`def kadane(arr: list[int]) -> int:\r
...
`;function _y(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Dynamic Programming"}),o.jsx("section",{id:"dp-top-down",children:o.jsxs(g,{title:"DP top-down",children:[o.jsx(g.Tab,{code:py,language:"python"}),o.jsx(g.Tab,{code:vy,language:"javascript"})]})}),o.jsx("section",{id:"dp-bottom-up",children:o.jsxs(g,{title:"DP bottom-up",children:[o.jsx(g.Tab,{code:gy,language:"python"}),o.jsx(g.Tab,{code:yy,language:"javascript"})]})}),o.jsx("section",{id:"dp-kadane",children:o.jsxs(g,{title:"Kadane (max-sum subarray)",children:[o.jsx(g.Tab,{code:my,language:"python"}),o.jsx(g.Tab,{code:xy,language:"javascript"})]})})]})}const wy=`def test_kth_bit(num: int, k: int) -> bool:\r
    return num & (1 << k) != 0\r
`,jy=`def set_kth_bit(num: int, k: int) -> int:\r
    return num | (1 << k)\r
`,Sy=`def clear_kth_bit(num: int, k: int) -> int:\r
    return num & ~(1 << k)\r
`,ky=`def toggle_kth_bit(num: int, k: int) -> int:\r
    return num ^ (1 << k)\r
`,Ey=`def get_rightmost_set_bit(num: int) -> int:\r
    return num & -num\r
`,Ty=`def count_set_bits(num: int) -> int:\r
    return bin(num).count('1')\r
`,Ny=`def multiply_by_power_of_two(num: int, k: int) -> int:\r
    return num << k\r
`,Oy=`def divide_by_power_of_two(num: int, k: int) -> int:\r
    return num >> k\r
`,by=`def is_power_of_two(num: int) -> bool:\r
    return (num & (num - 1)) == 0\r
`,Cy=`def swap_variables(num1: int, num2: int) -> tuple:\r
    num1 ^= num2\r
    num2 ^= num1\r
    num1 ^= num2\r
    return num1, num2\r
`,Ay=`const testKthBit = (num, k) => {\r
    return num & (1 << k) !== 0\r
}\r
`,Ry=`const setKthBit = (num, k) => {\r
    return num | (1 << k)\r
}\r
`,Py=`const clearKthBit = (num, k) => {\r
    return num & ~(1 << k)\r
}\r
`,My=`const toggleKthBit = (num, k) => {\r
    return num ^ (1 << k)\r
}\r
`,Ly=`const getRightmostSetBit = (num) => {\r
    return num & -num\r
}\r
`,Iy=`const countSetBits = (num) => {\r
    return num.toString(2).split('1').length - 1\r
}\r
`,Dy=`const multiplyByPowerOfTwo = (num, k) => {\r
    return num << k\r
}\r
`,By=`const divideByPowerOfTwo = (num, k) => {\r
    return num >> k;\r
}\r
`,zy=`const isPowerOfTwo = (num) => {\r
    return (num & (num - 1)) === 0\r
}\r
`,Fy=`const swapVariables = (num1, num2) => {\r
    num1 ^= num2\r
    num2 ^= num1\r
    num1 ^= num2\r
    return [num1, num2]\r
}\r
`;function Uy(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Bit Manipulation"}),o.jsx("section",{id:"bitmanipulation-test-kth-bit",children:o.jsxs(g,{title:"test kth-bit",children:[o.jsx(g.Tab,{code:wy,language:"python"}),o.jsx(g.Tab,{code:Ay,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-set-kth-bit",children:o.jsxs(g,{title:"set kth bit",children:[o.jsx(g.Tab,{code:jy,language:"python"}),o.jsx(g.Tab,{code:Ry,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-clear-kth-bit",children:o.jsxs(g,{title:"clear kth bit",children:[o.jsx(g.Tab,{code:Sy,language:"python"}),o.jsx(g.Tab,{code:Py,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-toggle-kth-bit",children:o.jsxs(g,{title:"toggle kth bit",children:[o.jsx(g.Tab,{code:ky,language:"python"}),o.jsx(g.Tab,{code:My,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-get-rightmost-bit",children:o.jsxs(g,{title:"get rightmost bit",children:[o.jsx(g.Tab,{code:Ey,language:"python"}),o.jsx(g.Tab,{code:Ly,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-count-set-bits",children:o.jsxs(g,{title:"count set bits",children:[o.jsx(g.Tab,{code:Ty,language:"python"}),o.jsx(g.Tab,{code:Iy,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-multiply-power-of-two",children:o.jsxs(g,{title:"multiply by 2^k",children:[o.jsx(g.Tab,{code:Ny,language:"python"}),o.jsx(g.Tab,{code:Dy,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-divide-power-of-two",children:o.jsxs(g,{title:"divide by 2^k",children:[o.jsx(g.Tab,{code:Oy,language:"python"}),o.jsx(g.Tab,{code:By,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-check-power-of-two",children:o.jsxs(g,{title:"check if number is power of 2",children:[o.jsx(g.Tab,{code:by,language:"python"}),o.jsx(g.Tab,{code:zy,language:"javascript"})]})}),o.jsx("section",{id:"bitmanipulation-swap-variables",children:o.jsxs(g,{title:"swap two variables",children:[o.jsx(g.Tab,{code:Cy,language:"python"}),o.jsx(g.Tab,{code:Fy,language:"javascript"})]})})]})}const Hy=`def fn(matrix: list[list[int]]):\r
    r = len(matrix)\r
    c = len(matrix[0])\r
\r
...
`,Wy=`def fn(matrix: list[list[int]]):\r
    r = len(matrix)\r
    c = len(matrix[0])\r
\r
...
`;function Vy(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Matrix"}),o.jsx("section",{id:"matrix-create-copy",children:o.jsxs(g,{title:"create / copy",children:[o.jsx(g.Tab,{code:Hy,language:"python"}),o.jsx(g.Tab,{code:Yy,language:"javascript"})]})}),o.jsx("section",{id:"matrix-diagonals",children:o.jsxs(g,{title:"diagonals / anti-diagonals",children:[o.jsx(g.Tab,{code:$y,language:"python"}),o.jsx(g.Tab,{code:Gy,language:"javascript"})]})}),o.jsx("section",{id:"matrix-rotate-transpose",children:o.jsxs(g,{title:"rotate / transpose",children:[o.jsx(g.Tab,{code:Wy,language:"python"}),o.jsx(g.Tab,{code:Qy,language:"javascript"})]})})]})}const Ky=`from typing import Any\r
\r
\r
class Array:\r
...
`;function g1(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Data Structures"}),o.jsx("section",{id:"ds-array",children:o.jsxs(g,{title:"array",children:[o.jsx(g.Tab,{code:Ky,language:"python"}),o.jsx(g.Tab,{code:o1,language:"javascript"})]})}),o.jsx("section",{id:"ds-hash-map",children:o.jsxs(g,{title:"hash map",children:[o.jsx(g.Tab,{code:n1,language:"python"}),o.jsx(g.Tab,{code:d1,language:"javascript"})]})}),o.jsx("section",{id:"ds-linked-list",children:o.jsxs(g,{title:"linked list",children:[o.jsx(g.Tab,{code:Zy,language:"python"}),o.jsx(g.Tab,{code:a1,language:"javascript"})]})}),o.jsx("section",{id:"ds-doubly-linked-list",children:o.jsxs(g,{title:"doubly linked list",children:[o.jsx(g.Tab,{code:qy,language:"python"}),o.jsx(g.Tab,{code:u1,language:"javascript"})]})}),o.jsx("section",{id:"ds-binary-tree",children:o.jsxs(g,{title:"binary tree",children:[o.jsx(g.Tab,{code:Jy,language:"python"}),o.jsx(g.Tab,{code:s1,language:"javascript"})]})}),o.jsx("section",{id:"ds-binary-search-tree",children:o.jsxs(g,{title:"binary search tree",children:[o.jsx(g.Tab,{code:Xy,language:"python"}),o.jsx(g.Tab,{code:l1,language:"javascript"})]})}),o.jsx("section",{id:"ds-graph",children:o.jsxs(g,{title:"graph",children:[o.jsx(g.Tab,{code:e1,language:"python"}),o.jsx(g.Tab,{code:c1,language:"javascript"})]})}),o.jsx("section",{id:"ds-union-find",children:o.jsxs(g,{title:"union find",children:[o.jsx(g.Tab,{code:t1,language:"python"}),o.jsx(g.Tab,{code:h1,language:"javascript"})]})}),o.jsx("section",{id:"ds-union-find-optimized",children:o.jsxs(g,{title:"union find optimized",children:[o.jsx(g.Tab,{code:i1,language:"python"}),o.jsx(g.Tab,{code:p1,language:"javascript"})]})}),o.jsx("section",{id:"ds-trie",children:o.jsxs(g,{title:"trie",children:[o.jsx(g.Tab,{code:r1,language:"python"}),o.jsx(g.Tab,{code:f1,language:"javascript"})]})})]})}const m1=`import random\r
\r
\r
...
`,v1=`def bubble_sort(arr: list) -> None:\r
    n = len(arr)\r
\r
    for i in range(n):\r
        swapped = False\r
...
\r
        if not swapped:\r
            break\r
`,y1=`def bucket_sort(arr: list) -> list:\r
    num_buckets = 10\r
    min_num = min(arr)\r
    max_num = max(arr)\r
...
`,x1=`def counting_sort(arr: list) -> list:\r
    max_num = max(arr)\r
    min_num = min(arr)\r
...
\r
    return output\r
`,_1=`def cube_sort(arr: list, processors: int) -> None:\r
    n = len(arr)\r
    subarrays = []\r
...
`,w1=`def heap_sort(arr: list) -> list:\r
    n = len(arr)\r
\r
...
`,j1=`def insertion_sort(arr: list) -> None:\r
    n = len(arr)\r
\r
    for i in range(1, n):\r
        key = arr[i]\r
...
\r
        arr[i] = key\r
`,S1=`def merge_sort(arr: list) -> list:\r
    n = len(arr)\r
\r
    if n <= 1:\r
        return arr\r
...
\r
    return max_idx\r
`,E1=`def quick_sort(arr: list) -> list:\r
    n = len(arr)\r
\r
    if n <= 1:\r
        return arr\r
...
`,T1=`def radix_sort(arr: list) -> None:\r
    max_val = max(arr)\r
    exp = 1\r
\r
...
\r
    for i in range(n):\r
        arr[i] = output[i]\r
`,N1=`def selection_sort(arr: list) -> None:\r
    n = len(arr)\r
\r
    for i in range(n):\r
        min_i = i\r
...
`,O1=`def shell_sort(arr: list) -> None:\r
    n = len(arr)\r
...
\r
            if j != i:\r
                arr[j] = tmp\r
`,b1=`from threading import Thread\r
...
def snorlax(num: float, arr: list) -> None:\r
    sleep(num / 1000.0)\r
    arr.append(num)\r
`,C1=`def tim_sort(arr: list) -> list:\r
    n = len(arr)\r
    min_run = 32\r
\r
...
`,L1=`const cubeSort = (arr, processors) => {\r
    const n = arr.length\r
    const subarrays = []\r
...
`;function G1(){return o.jsxs("div",{className:ae.container,children:[o.jsx("h2",{className:ae.sectionHeader,children:"Sorting Algorithms"}),o.jsx("section",{id:"sort-bubble",children:o.jsxs(g,{title:"bubble sort",children:[o.jsx(g.Tab,{code:v1,language:"python"}),o.jsx(g.Tab,{code:R1,language:"javascript"})]})}),o.jsx("section",{id:"sort-selection",children:o.jsxs(g,{title:"selection sort",children:[o.jsx(g.Tab,{code:N1,language:"python"}),o.jsx(g.Tab,{code:H1,language:"javascript"})]})}),o.jsx("section",{id:"sort-insertion",children:o.jsxs(g,{title:"insertion sort",children:[o.jsx(g.Tab,{code:j1,language:"python"}),o.jsx(g.Tab,{code:D1,language:"javascript"})]})}),o.jsx("section",{id:"sort-shell",children:o.jsxs(g,{title:"shell sort",children:[o.jsx(g.Tab,{code:O1,language:"python"}),o.jsx(g.Tab,{code:$1,language:"javascript"})]})}),o.jsx("section",{id:"sort-merge",children:o.jsxs(g,{title:"merge sort",children:[o.jsx(g.Tab,{code:S1,language:"python"}),o.jsx(g.Tab,{code:B1,language:"javascript"})]})}),o.jsx("section",{id:"sort-quick",children:o.jsxs(g,{title:"quick sort",children:[o.jsx(g.Tab,{code:E1,language:"python"}),o.jsx(g.Tab,{code:F1,language:"javascript"})]})}),o.jsx("section",{id:"sort-tim",children:o.jsxs(g,{title:"timsort",children:[o.jsx(g.Tab,{code:C1,language:"python"}),o.jsx(g.Tab,{code:Y1,language:"javascript"})]})}),o.jsx("section",{id:"sort-heap",children:o.jsxs(g,{title:"heap sort",children:[o.jsx(g.Tab,{code:w1,language:"python"}),o.jsx(g.Tab,{code:I1,language:"javascript"})]})}),o.jsx("section",{id:"sort-counting",children:o.jsxs(g,{title:"counting sort",children:[o.jsx(g.Tab,{code:x1,language:"python"}),o.jsx(g.Tab,{code:M1,language:"javascript"})]})}),o.jsx("section",{id:"sort-bucket",children:o.jsxs(g,{title:"bucket sort",children:[o.jsx(g.Tab,{code:y1,language:"python"}),o.jsx(g.Tab,{code:P1,language:"javascript"})]})}),o.jsx("section",{id:"sort-radix",children:o.jsxs(g,{title:"radix sort",children:[o.jsx(g.Tab,{code:T1,language:"python"}),o.jsx(g.Tab,{code:U1,language:"javascript"})]})}),o.jsx("section",{id:"sort-cube",children:o.jsxs(g,{title:"cubesort",children:[o.jsx(g.Tab,{code:_1,language:"python"}),o.jsx(g.Tab,{code:L1,language:"javascript"})]})}),o.jsx("section",{id:"sort-bogo",children:o.jsxs(g,{title:"bogo sort",children:[o.jsx(g.Tab,{code:m1,language:"python"}),o.jsx(g.Tab,{code:A1,language:"javascript"})]})}),o.jsx("section",{id:"sort-pancake",children:o.jsxs(g,{title:"pancake sort",children:[o.jsx(g.Tab,{code:k1,language:"python"}),o.jsx(g.Tab,{code:z1,language:"javascript"})]})}),o.jsx("section",{id:"sort-sleep",children:o.jsxs(g,{title:"sleep sort",children:[o.jsx(g.Tab,{code:b1,language:"python"}),o.jsx(g.Tab,{code:W1,language:"javascript"})]})})]})}function Q1(){const{isSidebarOpen:e}=Il(),n=en(nu.main,!e&&nu.sidebarHidden);return o.jsxs("main",{className:n,children:[o.jsx(Bg,{}),o.jsx(dv,{}),o.jsx(mv,{}),o.jsx(wv,{}),o.jsx(Tv,{}),o.jsx(Pv,{}),o.jsx(Jv,{}),o.jsx(qv,{}),o.jsx(cy,{}),o.jsx(hy,{}),o.jsx(_y,{}),o.jsx(Uy,{}),o.jsx(Vy,{}),o.jsx(g1,{}),o.jsx(G1,{})]})}function V1(){return o.jsx(mi.StrictMode,{children:o.jsx(xp,{children:o.jsxs("div",{className:"App",children:[o.jsx(jp,{}),o.jsx(wg,{}),o.jsx(Q1,{})]})})})}Vo.createRoot(document.getElementById("root")).render(o.jsx(V1,{}));
