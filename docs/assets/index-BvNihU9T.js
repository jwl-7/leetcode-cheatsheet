 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(S,R){var I=S.length;S.push(R);e:for(;0<I;){var U=I-1>>>1,X=S[U];if(0<i(X,R))S[U]=R,S[I]=X,I=U;else break e}}function t(S){return S.length===0?null:S[0]}function r(S){if(S.length===0)return null;var R=S[0],I=S.pop();if(I!==R){S[0]=I;e:for(var U=0,X=S.length,ke=X>>>1;U<ke;){var Ee=2*(U+1)-1,ae=S[Ee],se=Ee+1,de=S[se];if(0>i(ae,I))se<X&&0>i(de,ae)?(S[U]=de,S[se]=I,U=se):(S[U]=ae,S[Ee]=I,U=Ee);else if(se<X&&0>i(de,I))S[U]=de,S[se]=I,U=se;else break e}}return R}function i(S,R){var I=S.sortIndex-R.sortIndex;return I!==0?I:S.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var u=[],c=[],g=1,v=null,h=3,m=!1,x=!1,w=!1,b=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(S){for(var R=t(c);R!==null;){if(R.callback===null)r(c);else if(R.startTime<=S)r(c),R.sortIndex=R.expirationTime,n(u,R);else break;R=t(c)}}function _(S){if(w=!1,p(S),!x)if(t(u)!==null)x=!0,Se(k);else{var R=t(c);R!==null&&C(_,R.startTime-S)}}function k(S,R){x=!1,w&&(w=!1,f(P),P=-1),m=!0;var I=h;try{for(p(R),v=t(u);v!==null&&(!(v.expirationTime>R)||S&&!W());){var U=v.callback;if(typeof U=="function"){v.callback=null,h=v.priorityLevel;var X=U(v.expirationTime<=R);R=e.unstable_now(),typeof X=="function"?v.callback=X:v===t(u)&&r(u),p(R)}else r(u);v=t(u)}if(v!==null)var ke=!0;else{var Ee=t(c);Ee!==null&&C(_,Ee.startTime-R),ke=!1}return ke}finally{v=null,h=I,m=!1}}var E=!1,N=null,P=-1,T=5,L=-1;function W(){return!(e.unstable_now()-L<T)}function Q(){if(N!==null){var S=e.unstable_now();L=S;var R=!0;try{R=N(!0,S)}finally{R?$():(E=!1,N=null)}}else E=!1}var $;if(typeof d=="function")$=function(){d(Q)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,ye=fe.port2;fe.port1.onmessage=Q,$=function(){ye.postMessage(null)}}else $=function(){b(Q,0)};function Se(S){N=S,E||(E=!0,$())}function C(S,R){P=b(function(){S(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(S){S.callback=null},e.unstable_continueExecution=function(){x||m||(x=!0,Se(k))},e.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<S?Math.floor(1e3/S):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(S){switch(h){case 1:case 2:case 3:var R=3;break;default:R=h}var I=h;h=R;try{return S()}finally{h=I}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(S,R){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var I=h;h=S;try{return R()}finally{h=I}},e.unstable_scheduleCallback=function(S,R,I){var U=e.unstable_now();switch(typeof I=="object"&&I!==null?(I=I.delay,I=typeof I=="number"&&0<I?U+I:U):I=U,S){case 1:var X=-1;break;case 2:X=250;break;case 5:X=1073741823;break;case 4:X=1e4;break;default:X=5e3}return X=I+X,S={id:g++,callback:R,priorityLevel:S,startTime:I,expirationTime:X,sortIndex:-1},I>U?(S.sortIndex=I,n(c,S),t(u)===null&&S===t(c)&&(w?(f(P),P=-1):w=!0,C(_,I-U))):(S.sortIndex=X,n(u,S),x||m||(x=!0,Se(k))),S},e.unstable_shouldYield=W,e.unstable_wrapCallback=function(S){var R=h;return function(){var I=h;h=R;try{return S.apply(this,arguments)}finally{h=I}}}})(ju);Su.exports=ju;var gf=Su.exports;/**
 * @license React
...
\r
    while left < right:\r
        # do some logic here with left and right\r
        if CONDITION:\r
            left += 1\r
        else:\r
            right -= 1\r
...
\r
    for num in arr:\r
        # for monotonic decreasing, just flip the > to <\r
...
`;function Ov(){return o.jsxs("div",{className:he.container,children:[o.jsx("h2",{className:he.sectionHeader,children:"Binary Tree"}),o.jsx("section",{id:"tree-dfs-recursive",children:o.jsxs(j,{title:"DFS (recursive)",children:[o.jsx(j.Tab,{code:jv,language:"python"}),o.jsx(j.Tab,{code:Nv,language:"javascript"})]})}),o.jsx("section",{id:"tree-dfs-iterative",children:o.jsxs(j,{title:"DFS (iterative)",children:[o.jsx(j.Tab,{code:kv,language:"python"}),o.jsx(j.Tab,{code:Tv,language:"javascript"})]})}),o.jsx("section",{id:"tree-bfs",children:o.jsxs(j,{title:"BFS",children:[o.jsx(j.Tab,{code:Ev,language:"python"}),o.jsx(j.Tab,{code:Cv,language:"javascript"})]})})]})}const bv=`def fn(graph):\r
    def dfs(node):\r
        ans = 0\r
        # do some logic\r
...
`,Gv=`def fn(arr):\r
    def check(x):\r
        # this function is implemented depending on the problem\r
        return BOOLEAN\r
\r
...
\r
    ...
    for (ITERATE_OVER_INPUT):\r
        # modify the current state\r
        ans += backtrack(curr, OTHER_ARGUMENTS...)\r
        # undo the modification of the current state\r
\r
    return ans\r
...
\r
    return output\r
`;function Py(){return o.jsxs("div",{className:he.container,children:[o.jsx("h2",{className:he.sectionHeader,children:"Sorting Algorithms"}),o.jsx("section",{id:"sort-bubble",children:o.jsx(j,{title:"bubble sort",children:o.jsx(j.Tab,{code:xy,language:"python"})})}),o.jsx("section",{id:"sort-selection",children:o.jsx(j,{title:"selection sort",children:o.jsx(j.Tab,{code:Oy,language:"python"})})}),o.jsx("section",{id:"sort-insertion",children:o.jsx(j,{title:"insertion sort",children:o.jsx(j.Tab,{code:ky,language:"python"})})}),o.jsx("section",{id:"sort-shell",children:o.jsx(j,{title:"shell sort",children:o.jsx(j.Tab,{code:by,language:"python"})})}),o.jsx("section",{id:"sort-merge",children:o.jsx(j,{title:"merge sort",children:o.jsx(j.Tab,{code:Ey,language:"python"})})}),o.jsx("section",{id:"sort-quick",children:o.jsx(j,{title:"quick sort",children:o.jsx(j.Tab,{code:Ty,language:"python"})})}),o.jsx("section",{id:"sort-tim",children:o.jsx(j,{title:"timsort",children:o.jsx(j.Tab,{code:Ay,language:"python"})})}),o.jsx("section",{id:"sort-heap",children:o.jsx(j,{title:"heap sort",children:o.jsx(j.Tab,{code:jy,language:"python"})})}),o.jsx("section",{id:"sort-counting",children:o.jsx(j,{title:"counting sort",children:o.jsx(j.Tab,{code:wy,language:"python"})})}),o.jsx("section",{id:"sort-bucket",children:o.jsx(j,{title:"bucket sort",children:o.jsx(j.Tab,{code:_y,language:"python"})})}),o.jsx("section",{id:"sort-radix",children:o.jsx(j,{title:"radix sort",children:o.jsx(j.Tab,{code:Cy,language:"python"})})}),o.jsx("section",{id:"sort-cube",children:o.jsx(j,{title:"cubesort",children:o.jsx(j.Tab,{code:Sy,language:"python"})})}),o.jsx("section",{id:"sort-bogo",children:o.jsx(j,{title:"bogo sort",children:o.jsx(j.Tab,{code:yy,language:"python"})})}),o.jsx("section",{id:"sort-pancake",children:o.jsx(j,{title:"pancake sort",children:o.jsx(j.Tab,{code:Ny,language:"python"})})}),o.jsx("section",{id:"sort-sleep",children:o.jsx(j,{title:"sleep sort",children:o.jsx(j.Tab,{code:Ry,language:"python"})})})]})}function My(){const{isSidebarOpen:e}=Is(),n=en(nu.main,!e&&nu.sidebarHidden);return o.jsxs("main",{className:n,children:[o.jsx(zg,{}),o.jsx(dv,{}),o.jsx(hv,{}),o.jsx(xv,{}),o.jsx(Sv,{}),o.jsx(Ov,{}),o.jsx(zv,{}),o.jsx(Uv,{}),o.jsx(Jv,{}),o.jsx(ny,{}),o.jsx(oy,{}),o.jsx(vy,{}),o.jsx(Py,{})]})}function Ly(){return o.jsx(mi.StrictMode,{children:o.jsx(xh,{children:o.jsxs("div",{className:"App",children:[o.jsx(Sh,{}),o.jsx(wg,{}),o.jsx(My,{})]})})})}Ql.createRoot(document.getElementById("root")).render(o.jsx(Ly,{}));
