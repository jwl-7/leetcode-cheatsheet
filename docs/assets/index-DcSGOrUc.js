 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(S,R){var D=S.length;S.push(R);e:for(;0<D;){var U=D-1>>>1,X=S[U];if(0<i(X,R))S[U]=R,S[D]=X,D=U;else break e}}function t(S){return S.length===0?null:S[0]}function r(S){if(S.length===0)return null;var R=S[0],D=S.pop();if(D!==R){S[0]=D;e:for(var U=0,X=S.length,ke=X>>>1;U<ke;){var Ee=2*(U+1)-1,ae=S[Ee],se=Ee+1,de=S[se];if(0>i(ae,D))se<X&&0>i(de,ae)?(S[U]=de,S[se]=D,U=se):(S[U]=ae,S[Ee]=D,U=Ee);else if(se<X&&0>i(de,D))S[U]=de,S[se]=D,U=se;else break e}}return R}function i(S,R){var D=S.sortIndex-R.sortIndex;return D!==0?D:S.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var u=[],c=[],g=1,v=null,h=3,m=!1,x=!1,w=!1,b=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(S){for(var R=t(c);R!==null;){if(R.callback===null)r(c);else if(R.startTime<=S)r(c),R.sortIndex=R.expirationTime,n(u,R);else break;R=t(c)}}function _(S){if(w=!1,p(S),!x)if(t(u)!==null)x=!0,Se(k);else{var R=t(c);R!==null&&O(_,R.startTime-S)}}function k(S,R){x=!1,w&&(w=!1,f(P),P=-1),m=!0;var D=h;try{for(p(R),v=t(u);v!==null&&(!(v.expirationTime>R)||S&&!W());){var U=v.callback;if(typeof U=="function"){v.callback=null,h=v.priorityLevel;var X=U(v.expirationTime<=R);R=e.unstable_now(),typeof X=="function"?v.callback=X:v===t(u)&&r(u),p(R)}else r(u);v=t(u)}if(v!==null)var ke=!0;else{var Ee=t(c);Ee!==null&&O(_,Ee.startTime-R),ke=!1}return ke}finally{v=null,h=D,m=!1}}var E=!1,N=null,P=-1,T=5,L=-1;function W(){return!(e.unstable_now()-L<T)}function Q(){if(N!==null){var S=e.unstable_now();L=S;var R=!0;try{R=N(!0,S)}finally{R?$():(E=!1,N=null)}}else E=!1}var $;if(typeof d=="function")$=function(){d(Q)};else if(typeof MessageChannel<"u"){var fe=new MessageChannel,ye=fe.port2;fe.port1.onmessage=Q,$=function(){ye.postMessage(null)}}else $=function(){b(Q,0)};function Se(S){N=S,E||(E=!0,$())}function O(S,R){P=b(function(){S(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(S){S.callback=null},e.unstable_continueExecution=function(){x||m||(x=!0,Se(k))},e.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<S?Math.floor(1e3/S):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return t(u)},e.unstable_next=function(S){switch(h){case 1:case 2:case 3:var R=3;break;default:R=h}var D=h;h=R;try{return S()}finally{h=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(S,R){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var D=h;h=S;try{return R()}finally{h=D}},e.unstable_scheduleCallback=function(S,R,D){var U=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?U+D:U):D=U,S){case 1:var X=-1;break;case 2:X=250;break;case 5:X=1073741823;break;case 4:X=1e4;break;default:X=5e3}return X=D+X,S={id:g++,callback:R,priorityLevel:S,startTime:D,expirationTime:X,sortIndex:-1},D>U?(S.sortIndex=D,n(c,S),t(u)===null&&S===t(c)&&(w?(f(P),P=-1):w=!0,O(_,D-U))):(S.sortIndex=X,n(u,S),x||m||(x=!0,Se(k))),S},e.unstable_shouldYield=W,e.unstable_wrapCallback=function(S){var R=h;return function(){var D=h;h=R;try{return S.apply(this,arguments)}finally{h=D}}}})(ju);Su.exports=ju;var gf=Su.exports;/**
 * @license React
